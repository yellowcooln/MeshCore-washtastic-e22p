...
We need to update the bootloader on the ProMicros. Make sure to follow [promicro-upgrade.md](https://github.com/yellowcooln/MeshCore-washtastic-e22p/blob/v1.16.0-washtastic/promicro-upgrade.md) before flashing the custom firmware.
