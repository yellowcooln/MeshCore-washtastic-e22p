...
- `sleep_us`: Sleep duration in microseconds (`6016`-`30000000` on the Photon nRF52 SX1262).
...
**Notes:**
- Available in the MeshSmith Photon nRF52 BatteryInfo PowerSaving repeater target.
